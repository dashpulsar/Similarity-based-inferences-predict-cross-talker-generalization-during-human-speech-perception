...
- [Within-condition summary](acoustic_diagnostic/within_condition/summary.csv) and [flagged fits](acoustic_diagnostic/within_condition/flagged_fits.csv).
...
- [Common-structure comparisons](common_structure/comparison_summary.csv), [variance components for flagged fits](common_structure/flagged_variance_components.csv), and [run checks](common_structure/result_metadata.json).
