...
- [Conditional S-curves](../../analysis_update_2026-08-21/figures/s_curves_tr24/) and [their source manifest](../../analysis_update_2026-08-21/tables/s_curve_figure_manifest.csv): retain X21's multiple conditions and talkers.
- [Matched-content talker distance table](../../analysis_update_2026-08-21/tables/talker_distance_tr24.csv): X21 cells average its 32 matched sentences; AN19 and B23 have separate content sets. This is not a distance-correlation matrix.
- [Combined-fold nested comparisons](../../analysis_update_2026-09-01/README.md): supplementary association tests, not z layer plots.
