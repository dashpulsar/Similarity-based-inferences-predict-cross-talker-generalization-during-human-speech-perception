...
Applies to `sbi_an19_base_z`, `sbi_an19_ft_z`, `sbi_x21_base_z`, `sbi_x21_ft_z`, `sbi_b23_base_z`, and `sbi_b23_ft_z` in `analysis_update_2026-09-09/figures`.
...
Applies to the six `sbi_{dataset}_{variant}_loglik` figures in `analysis_update_2026-09-09/figures`.
...
Applies to all 11 `hve_revised_{dataset}_{nn}` figures in `analysis_update_2026-09-06/z_value_review/figures`.
...
Applies to all 11 `hve_{dataset}_loglik_{nn}` figures in `analysis_update_2026-09-09/figures`.
...
Available figure: `analysis_update_2026-09-01/figures/figure_01_crossfitted_nested_lrt`. Retained September 9 report uses the exact X21 table in place of this dense figure; the figure is optional rather than mandatory. Do not confuse it with an OOF-gain figure or a z profile.
...
Figure: `x21_s_curves_by_condition` in `analysis_update_2026-09-09/figures`.
...
Figure: `x21_s_curves_pooled` in `analysis_update_2026-09-09/figures`.
...
| Retained SBI z values | `analysis_update_2026-09-09/tables/sbi_retained_fold_z.csv` |
| Historical ceiling values | `analysis_update_2026-09-09/tables/shared_historical_ceiling_z.csv` |
| Revised HVE signed z, 7/17/15 definitions, fit diagnostics | `analysis_update_2026-09-06/z_value_review/tables/revised_hve_training_fold_z.csv` and `revised_hve_coverage.csv` |
| Frozen predictor-only likelihood values | `analysis_update_2026-09-09/tables/sbi_retained_fold_loglik.csv` and `hve_retained_fold_loglik.csv` |
...
| Selected candidate identity and loss criterion | `analysis_update_2026-08-27/tables/sbi_predictor_only_selected_layers.csv`, `hve_predictor_only_selected_methods.csv` |
| Combined-data test implementation and exact results | `R/fit_crossfitted_lrt.R`, `analysis_update_2026-09-01/tables/crossfitted_lrt_results.csv` and `crossfitted_model_diagnostics.csv` |
| X21 curve formula, k, populations, CI provenance limitation | `analysis_update_2026-09-09/tables/x21_s_curve_revision_provenance.json` |
