...
| Full-condition X21 analysis | [Methods and results](../../analysis/sbi/parameter_maps/x21_all_conditions/README.md) | Training z and likelihood surfaces. |
| X21 excluding Talker-specific | [Methods and results](../../analysis/sbi/parameter_maps/x21_without_talker_specific/README.md) | Separate response sample; do not directly compare raw score magnitudes between samples. |
| Training/test diagnostics | [Six SBI plots and scoring details](../../analysis/diagnostics/sbi_review/README.md) | Per-response test/train mean log loss; existing fixed-distance analyses. |
| AN19 acoustic-baseline investigation | [Evidence and open questions](../../analysis/acoustic_baselines/AN19_BASELINE_EXPLANATION.md) | Descriptive checks provide clues, not a definitive causal explanation. |
| Cross-fitted model comparisons | [September 1 results](../../analysis/model_comparison/pooled_lrt/README.md) | Pooled GLMM comparisons with the limitations recorded there. |
| Figure and phoneme work | [September 9 report index](../../analysis/speech/README.md) | Automatic annotation and manuscript-panel drafts, with coverage caveats. |
| Existing progress record | [September 17](../../analysis/diagnostics/PROGRESS_REPORT.md), [September 18](../../analysis/sbi/README.md) | Dated records; not evidence that all open tasks are complete. |
