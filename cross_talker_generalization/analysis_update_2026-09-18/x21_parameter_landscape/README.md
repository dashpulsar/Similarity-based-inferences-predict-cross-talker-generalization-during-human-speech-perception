...
```text
python cross_talker_generalization/scripts/plot_sbi_landscape.py --input cross_talker_generalization/analysis_update_2026-09-18/x21_parameter_landscape
python cross_talker_generalization/scripts/export_sbi_landscape_interactive.py --input cross_talker_generalization/analysis_update_2026-09-18/x21_parameter_landscape
```
