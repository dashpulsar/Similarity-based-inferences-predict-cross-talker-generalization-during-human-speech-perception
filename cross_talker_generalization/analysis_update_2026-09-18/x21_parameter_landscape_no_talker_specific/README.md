...
```text
python cross_talker_generalization/scripts/run_sbi_landscape_subset.py --source cross_talker_generalization/analysis_update_2026-09-18/x21_parameter_landscape --output <new-directory> --rscript <Rscript-executable> --jobs 16 --budget-seconds 1800
```
