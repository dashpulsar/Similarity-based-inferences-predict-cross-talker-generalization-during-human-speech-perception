...
```powershell
python -X utf8 cross_talker_generalization/scripts/run_an19_phonetic_xeus.py --download --prepare-only --output-dir cross_talker_generalization/analysis_update_2026-09-09/an19_phonetic_xeus/setup_checks
```
...
python -X utf8 cross_talker_generalization/scripts/run_an19_phonetic_xeus.py `
  ...
  --source-manifest cross_talker_generalization/analysis_update_2026-09-09/an19_phone_alignment/tables/nygaard_audio_source_manifest.csv `
  --output-dir cross_talker_generalization/analysis_update_2026-09-09/an19_phonetic_xeus/nygaard_audio_reproduction
```
