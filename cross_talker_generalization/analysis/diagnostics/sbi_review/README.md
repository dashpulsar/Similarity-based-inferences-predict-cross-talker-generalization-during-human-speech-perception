...
| --- | --- | --- |
| AN19 | [Figure](../si_diagnostics/figures/AN19_SBI_base_similarity_all_participants_test_train_ratio.png) | [Figure](../si_diagnostics/figures/AN19_SBI_ft_similarity_all_participants_test_train_ratio.png) |
| X21 | [Figure](../si_diagnostics/figures/X21_SBI_base_similarity_all_participants_test_train_ratio.png) | [Figure](../si_diagnostics/figures/X21_SBI_ft_similarity_all_participants_test_train_ratio.png) |
| B23 | [Figure](../si_diagnostics/figures/B23_SBI_base_similarity_all_participants_test_train_ratio.png) | [Figure](../si_diagnostics/figures/B23_SBI_ft_similarity_all_participants_test_train_ratio.png) |
...
```text
python cross_talker_generalization/analysis/diagnostics/sbi_review/verify_saved_scores.py
```
